...
namespace EFCore_NorthwindDb.Migrations
{
    ...
    [Migration("20220904035405_Init_migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EFCore_NorthwindDb.AlphabeticalListOfProduct", b =>
                {
            ...
            modelBuilder.Entity("EFCore_NorthwindDb.Category", b =>
                {
                    b.Property<int>("CategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EFCore_NorthwindDb.CategorySalesFor1997", b =>
                {
                    b.Property<string>("CategoryName")
                        .IsRequired()
                        .HasMaxLength(15)
            ...
            modelBuilder.Entity("EFCore_NorthwindDb.CurrentProductList", b =>
                {
                    b.Property<int>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EFCore_NorthwindDb.Customer", b =>
                {
                    b.Property<string>("CustomerId")
                        .HasMaxLength(5)
                        .HasColumnType("nchar(5)")
            ...
            modelBuilder.Entity("EFCore_NorthwindDb.CustomerAndSuppliersByCity", b =>
                {
                    b.Property<string>("City")
                        .HasMaxLength(15)
                        .HasColumnType("nvarchar(15)");
            ...
            modelBuilder.Entity("EFCore_NorthwindDb.CustomerDemographic", b =>
                {
                    b.Property<string>("CustomerTypeId")
                        .HasMaxLength(10)
                        .HasColumnType("nchar(10)")
            ...
            modelBuilder.Entity("EFCore_NorthwindDb.Employee", b =>
                {
            ...
            modelBuilder.Entity("EFCore_NorthwindDb.Invoice", b =>
                {
                    b.Property<string>("Address")
                        .HasMaxLength(60)
                        .HasColumnType("nvarchar(60)");
            ...
            modelBuilder.Entity("EFCore_NorthwindDb.Order", b =>
                {
                    b.Property<int>("OrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EFCore_NorthwindDb.OrderDetail", b =>
                {
                    b.Property<int>("OrderId")
                        .HasColumnType("int")
                        .HasColumnName("OrderID");
            ...
            modelBuilder.Entity("EFCore_NorthwindDb.OrderDetailsExtended", b =>
                {
                    b.Property<float>("Discount")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("EFCore_NorthwindDb.OrdersQry", b =>
                {
                    b.Property<string>("Address")
                        .HasMaxLength(60)
                        .HasColumnType("nvarchar(60)");
            ...
            modelBuilder.Entity("EFCore_NorthwindDb.OrderSubtotal", b =>
                {
                    b.Property<int>("OrderId")
                        .HasColumnType("int")
                        .HasColumnName("OrderID");
            ...
            modelBuilder.Entity("EFCore_NorthwindDb.Product", b =>
                {
                    b.Property<int>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EFCore_NorthwindDb.ProductsAboveAveragePrice", b =>
                {
                    b.Property<string>("ProductName")
                        .IsRequired()
                        .HasMaxLength(40)
            ...
            modelBuilder.Entity("EFCore_NorthwindDb.ProductSalesFor1997", b =>
                {
                    b.Property<string>("CategoryName")
                        .IsRequired()
                        .HasMaxLength(15)
            ...
            modelBuilder.Entity("EFCore_NorthwindDb.ProductsByCategory", b =>
                {
                    b.Property<string>("CategoryName")
                        .IsRequired()
                        .HasMaxLength(15)
            ...
            modelBuilder.Entity("EFCore_NorthwindDb.QuarterlyOrder", b =>
                {
                    b.Property<string>("City")
                        .HasMaxLength(15)
                        .HasColumnType("nvarchar(15)");
            ...
            modelBuilder.Entity("EFCore_NorthwindDb.Region", b =>
                {
            ...
            modelBuilder.Entity("EFCore_NorthwindDb.SalesByCategory", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("int")
                        .HasColumnName("CategoryID");
            ...
            modelBuilder.Entity("EFCore_NorthwindDb.SalesTotalsByAmount", b =>
                {
                    b.Property<string>("CompanyName")
                        .IsRequired()
                        .HasMaxLength(40)
            ...
            modelBuilder.Entity("EFCore_NorthwindDb.SemuaProduct", b =>
                {
                    b.Property<int?>("CategoryId")
                        .HasColumnType("int")
                        .HasColumnName("CategoryID");
            ...
            modelBuilder.Entity("EFCore_NorthwindDb.Shipper", b =>
                {
            ...
            modelBuilder.Entity("EFCore_NorthwindDb.SummaryOfSalesByYear", b =>
                {
                    b.Property<int>("OrderId")
                        .HasColumnType("int")
                        .HasColumnName("OrderID");
            ...
            modelBuilder.Entity("EFCore_NorthwindDb.Supplier", b =>
                {
                    b.Property<int>("SupplierId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EFCore_NorthwindDb.Territory", b =>
                {
            ...
            modelBuilder.Entity("CustomerCustomerDemo", b =>
                {
                    b.HasOne("EFCore_NorthwindDb.Customer", null)
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .IsRequired()
                        .HasConstraintName("FK_CustomerCustomerDemo_Customers");

                    b.HasOne("EFCore_NorthwindDb.CustomerDemographic", null)
                        .WithMany()
            ...
            modelBuilder.Entity("EFCore_NorthwindDb.Employee", b =>
                {
                    b.HasOne("EFCore_NorthwindDb.Employee", "ReportsToNavigation")
            ...
            modelBuilder.Entity("EFCore_NorthwindDb.Order", b =>
                {
                    b.HasOne("EFCore_NorthwindDb.Customer", "Customer")
                        .WithMany("Orders")
                        .HasForeignKey("CustomerId")
                        .HasConstraintName("FK_Orders_Customers");

                    b.HasOne("EFCore_NorthwindDb.Employee", "Employee")
                        .WithMany("Orders")
                        .HasForeignKey("EmployeeId")
                        .HasConstraintName("FK_Orders_Employees");

                    b.HasOne("EFCore_NorthwindDb.Shipper", "ShipViaNavigation")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("EFCore_NorthwindDb.OrderDetail", b =>
                {
                    b.HasOne("EFCore_NorthwindDb.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .IsRequired()
                        .HasConstraintName("FK_Order_Details_Orders");

                    b.HasOne("EFCore_NorthwindDb.Product", "Product")
                        .WithMany("OrderDetails")
            ...
            modelBuilder.Entity("EFCore_NorthwindDb.Product", b =>
                {
                    b.HasOne("EFCore_NorthwindDb.Category", "Category")
                        .WithMany("Products")
                        .HasForeignKey("CategoryId")
                        .HasConstraintName("FK_Products_Categories");

                    b.HasOne("EFCore_NorthwindDb.Supplier", "Supplier")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("EFCore_NorthwindDb.Territory", b =>
                {
                    b.HasOne("EFCore_NorthwindDb.Region", "Region")
            ...
            modelBuilder.Entity("EmployeeTerritory", b =>
                {
                    b.HasOne("EFCore_NorthwindDb.Employee", null)
                        .WithMany()
                        .HasForeignKey("EmployeeId")
                        .IsRequired()
                        .HasConstraintName("FK_EmployeeTerritories_Employees");

                    b.HasOne("EFCore_NorthwindDb.Territory", null)
                        .WithMany()
